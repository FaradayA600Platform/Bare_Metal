...
#define SERIAL_IER_RTSEN            0x10      	/* RTS flow control  Enable */
#define SERIAL_IER_CTSEN             0x20      /* CTS flow control  Enable */
#define SERIAL_IER_DTREN            0x40      	/* DTR flow control Enable */
#define SERIAL_IER_DSREN             0x80      /* DSR flow control Enable */
...
//extern int fLib_scanf(char *buf);
#define fLib_gets       fLib_scanf
