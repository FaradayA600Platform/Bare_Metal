...
#define USER_MEM_SIZE (CONFIG_MEM_SIZE)
...
//    { CONFIG_MEM_BASE, CONFIG_MEM_BASE,  0x100000,     PTE_BLOCK_MEMTYPE(MT_NORMAL) | PTE_BLOCK_NS},   /* Cached + Buffered */   
//    {      0x18100000,      0x18100000,            0x100000,     PTE_BLOCK_MEMTYPE(MT_DEVICE_NGNRNE) | PTE_BLOCK_NON_SHARE},   /* Cached + Buffered */       
    {      0x00000000,      0x00000000,            0x18000000,    PTE_BLOCK_MEMTYPE(MT_DEVICE_NGNRNE) | PTE_BLOCK_NON_SHARE},    /* smc sram & rom */
//    {      0x18000000,      0x18000000,            0x8000000,    PTE_BLOCK_MEMTYPE(MT_NORMAL) | PTE_BLOCK_NS},    /* smc sram & rom */    
    {      0x18000000,      0x18000000,            0x200000,    PTE_BLOCK_MEMTYPE(MT_NORMAL) | PTE_BLOCK_NS},    /* smc sram & rom */  
    {      0x18300000,      0x18300000,            0x7e00000,    PTE_BLOCK_MEMTYPE(MT_DEVICE_NGNRNE) | PTE_BLOCK_NON_SHARE},    /* GIC400 */    
//    {      0x00000000,      0x00000000,            0x20000000,    PTE_BLOCK_MEMTYPE(MT_DEVICE_NGNRNE) | PTE_BLOCK_NON_SHARE},    /* smc sram & rom */
    {      0x20000000,      0x20000000,            0x10000000,    PTE_BLOCK_MEMTYPE(MT_DEVICE_NGNRNE) | PTE_BLOCK_NON_SHARE},   /* Uncached + Unbuffered : peripheral io map */
    {      0x80000000,      0x80000000,            0x20000000,    PTE_BLOCK_MEMTYPE(MT_NORMAL) | PTE_BLOCK_NS},   /* Uncached + Unbuffered : peripheral io map */
    { 0 },
};
#endif
